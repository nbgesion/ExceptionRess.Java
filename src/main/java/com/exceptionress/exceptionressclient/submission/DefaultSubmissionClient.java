...
import com.exceptionress.exceptionressclient.configuration.ValueProvider;
...
public class DefaultSubmissionClient implements SubmissionClientIF {
  private static final String CONFIGURATION_VERSION_HEADER = "x-exceptionress-configversion";
