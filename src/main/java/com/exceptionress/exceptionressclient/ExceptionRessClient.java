...
import com.exceptionress.exceptionressclient.plugins.EventPluginRunner;
import com.exceptionress.exceptionressclient.submission.SubmissionResponse;
import com.exceptionress.exceptionressclient.utils.VisibleForTesting;
...
@Slf4j
public class ExceptionRessClient {
  ...
  @Builder
  public ExceptionRessClient(Configuration configuration, Integer nThreads) {
    this(
        configuration,
  ...
  public static ExceptionRessClient from(String apiKey, String serverUrl) {
    return ExceptionRessClient.builder()
